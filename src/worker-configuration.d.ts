/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7163eb4313991e7568cbb46a71e57736)
// Runtime types generated with workerd@1.20250617.0 2024-08-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MAX_CONCURRENT_PROCESSING: "5" | "10";
		BATCH_SIZE: "10" | "20";
		RETRY_ATTEMPTS: "3";
		ENABLE_DETAILED_LOGGING: "false";
		d1_databases: {"binding":"APOD_D1","database_name":"apod-metadata-dev"};
		r2_buckets: {"binding":"APOD_R2","bucket_name":"apod-images-dev"};
		vectorize: {"binding":"VECTORIZE_INDEX","index_name":"apod-vectors-dev"};
		APOD_R2: R2Bucket;
		APOD_D1: D1Database;
